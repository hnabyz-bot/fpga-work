//==============================================================================
// p_define.sv - Macro-based Register Definitions
//==============================================================================
...
`DEFREG(ACQ_MODE,                   16'h00E6, 16'h0007)
...
`DEFREG(TI_ROIC_DESER_ALIGN_SHIFT_12, 16'h014C, 16'h0000)
`DEFREG(TI_ROIC_DESER_ALIGN_SHIFT_13, 16'h014D, 16'h0000)

// TI ROIC Deserializer Shift Set (0x0150 - 0x015D)
...
`DEFREG(TI_ROIC_DESER_SHIFT_SET_12,   16'h015C, 16'h0000)
`DEFREG(TI_ROIC_DESER_SHIFT_SET_13,   16'h015D, 16'h0000)
