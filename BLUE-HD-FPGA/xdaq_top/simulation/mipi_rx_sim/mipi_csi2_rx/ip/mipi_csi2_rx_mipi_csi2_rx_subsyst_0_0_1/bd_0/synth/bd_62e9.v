...
module bd_62e9
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.LITE_ACLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.LITE_ACLK, ASSOCIATED_BUSIF csirxss_s_axi, ASSOCIATED_CLKEN s_sc_aclken, ASSOCIATED_RESET lite_aresetn, CLK_DOMAIN /clk_wiz_0_clk_out1, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input lite_aclk;
  ...
  wire [2:0]NLW_xbar_M01_AXI_arprot_UNCONNECTED;
  wire [2:0]NLW_xbar_M01_AXI_awprot_UNCONNECTED;

  assign csirxss_s_axi_arready[0] = \^csirxss_s_axi_arready ;
  assign csirxss_s_axi_awready[0] = \^csirxss_s_axi_awready ;
  assign csirxss_s_axi_bvalid[0] = \^csirxss_s_axi_bvalid ;
  assign csirxss_s_axi_rvalid[0] = \^csirxss_s_axi_rvalid ;
  assign csirxss_s_axi_wready[0] = \^csirxss_s_axi_wready ;
  bd_62e9_phy_0 phy
  ...
  bd_62e9_xbar_0 xbar
       (.M00_AXI_araddr(xbar_M00_AXI_ARADDR),
        ...
        .S00_AXI_araddr(csirxss_s_axi_araddr),
        .S00_AXI_arprot(csirxss_s_axi_arprot),
        .S00_AXI_arready(\^csirxss_s_axi_arready ),
        .S00_AXI_arvalid(csirxss_s_axi_arvalid),
        .S00_AXI_awaddr(csirxss_s_axi_awaddr),
        .S00_AXI_awprot(csirxss_s_axi_awprot),
        .S00_AXI_awready(\^csirxss_s_axi_awready ),
        .S00_AXI_awvalid(csirxss_s_axi_awvalid),
        .S00_AXI_bready(csirxss_s_axi_bready),
        .S00_AXI_bresp(csirxss_s_axi_bresp),
        .S00_AXI_bvalid(\^csirxss_s_axi_bvalid ),
        .S00_AXI_rdata(csirxss_s_axi_rdata),
        .S00_AXI_rready(csirxss_s_axi_rready),
        .S00_AXI_rresp(csirxss_s_axi_rresp),
        .S00_AXI_rvalid(\^csirxss_s_axi_rvalid ),
        .S00_AXI_wdata(csirxss_s_axi_wdata),
        .S00_AXI_wready(\^csirxss_s_axi_wready ),
        .S00_AXI_wstrb(csirxss_s_axi_wstrb),
        .S00_AXI_wvalid(csirxss_s_axi_wvalid),
        .aclk(lite_aclk),
