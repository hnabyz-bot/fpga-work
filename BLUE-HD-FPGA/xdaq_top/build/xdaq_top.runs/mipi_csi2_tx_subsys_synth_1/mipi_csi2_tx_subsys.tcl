...
synth_design -top mipi_csi2_tx_subsys -part xc7a35tfgg484-1 -incremental_mode off -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix mipi_csi2_tx_subsys_ mipi_csi2_tx_subsys.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ mipi_csi2_tx_subsys_stub.v
 lappend ipCachedFiles mipi_csi2_tx_subsys_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ mipi_csi2_tx_subsys_stub.vhdl
 lappend ipCachedFiles mipi_csi2_tx_subsys_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ mipi_csi2_tx_subsys_sim_netlist.v
 lappend ipCachedFiles mipi_csi2_tx_subsys_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ mipi_csi2_tx_subsys_sim_netlist.vhdl
 lappend ipCachedFiles mipi_csi2_tx_subsys_sim_netlist.vhdl
 set TIME_taken [expr [clock seconds] - $TIME_start]

 if { [get_msg_config -count -severity {CRITICAL WARNING}] == 0 } {
  config_ip_cache -add -dcp mipi_csi2_tx_subsys.dcp -move_files $ipCachedFiles   -synth_runtime $TIME_taken  -ip [get_ips mipi_csi2_tx_subsys]
 }
...
rename_ref -prefix_all mipi_csi2_tx_subsys_

OPTRACE "write_checkpoint" START { CHECKPOINT }
# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef mipi_csi2_tx_subsys.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file mipi_csi2_tx_subsys_utilization_synth.rpt -pb mipi_csi2_tx_subsys_utilization_synth.pb"  } 
...
OPTRACE "mipi_csi2_tx_subsys_synth_1" END { }
