...
HD_PWD='D:/workspace/gittea-work/BLUE-HD-FPGA/xdaq_top/build/xdaq_top.runs/clk_ctrl_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_ctrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_ctrl.tcl
