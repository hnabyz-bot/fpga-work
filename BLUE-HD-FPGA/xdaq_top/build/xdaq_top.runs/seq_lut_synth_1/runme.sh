...
HD_PWD='D:/workspace/github-space/fpga-work/BLUE-HD-FPGA/xdaq_top/build/xdaq_top.runs/seq_lut_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seq_lut.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seq_lut.tcl
