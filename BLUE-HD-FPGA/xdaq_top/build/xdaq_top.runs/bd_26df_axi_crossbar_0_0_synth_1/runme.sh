...
HD_PWD='/home/holee/github_work/fpga-work/BLUE-HD-FPGA/xdaq_top/build/xdaq_top.runs/bd_26df_axi_crossbar_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_26df_axi_crossbar_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_26df_axi_crossbar_0_0.tcl
