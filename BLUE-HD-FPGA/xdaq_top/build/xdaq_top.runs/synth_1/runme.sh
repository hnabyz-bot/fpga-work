...
HD_PWD='D:/workspace/github-space/fpga-work/BLUE-HD-FPGA/xdaq_top/build/xdaq_top.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blue_hd_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blue_hd_top.tcl
