...
HD_PWD='D:/workspace/github-space/fpga-work/BLUE-HD-FPGA/xdaq_top/build/xdaq_top.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log blue_hd_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source blue_hd_top.tcl -notrace
