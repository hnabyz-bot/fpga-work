...
HD_PWD='D:/workspace/github-space/fpga-work/BLUE-HD-FPGA/xdaq_top/build/xdaq_top.runs/mipi_init_gen_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mipi_init_gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mipi_init_gen.tcl
