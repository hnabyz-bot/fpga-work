...
module bd_26df
  ...
  assign cl_tst_clk_out = mipi_dphy_0_cl_tst_clk_out;
  assign dl_tst_clk_out = mipi_dphy_0_dl_tst_clk_out;
  ...
  bd_26df_mipi_dphy_0_0 mipi_dphy_0
       (.cl_enable(mipi_csi2_tx_ctrl_0_tx_mipi_ppi_if_CL_ENABLE),
        .cl_tst_clk_out(mipi_dphy_0_cl_tst_clk_out),
        ...
        .dl3_txvalidesc(1'b0),
        .dl3_ulpsactivenot(mipi_csi2_tx_ctrl_0_tx_mipi_ppi_if_DL3_ULPSACTIVENOT),
        .dl_tst_clk_out(mipi_dphy_0_dl_tst_clk_out),
