...
`ifdef TB_SIM
	`define INIT_DELAY					25'd2
	`define MORE_DELAY					25'd2
`else
	// `define INIT_DELAY					25'h1FFFFFE //24'd33554430, rev6
	// `define MORE_DELAY					25'h1FFFFFE //24'd33554430, rev6
...
`define ROIC_VENDOR						16'h4144	// ADi
...
`define AED_GATE_OE_END_LINE_0			16'd3 // 16'd6
`define AED_READ_SKIP_START_LINE_0		16'd4 // 16'd7
`define AED_DATA_OUT_START_LINE_0		16'd3
`define AED_DATA_OUT_END_LINE_0			16'd5 // 16'd8
