...
module mipi_csi2_rx
  ...
  wire [31:0]axi_traffic_gen_0_status;
  ...
  wire [31:0]axi_traffic_gen_1_status;
  wire clk_100MHz_1;
  ...
  assign done = axi_traffic_gen_0_done;
  assign done_1 = axi_traffic_gen_1_done;
  ...
  assign rxbyteclkhs = mipi_csi2_rx_subsyst_0_rxbyteclkhs;
  assign status[31:0] = axi_traffic_gen_0_status;
  assign status_1[31:0] = axi_traffic_gen_1_status;
  assign video_out_tdata[31:0] = mipi_csi2_rx_subsyst_0_video_out_tdata;
  assign video_out_tdest[9:0] = mipi_csi2_rx_subsyst_0_video_out_tdest;
  assign video_out_tlast = mipi_csi2_rx_subsyst_0_video_out_tlast;
  assign video_out_tuser_0[0] = mipi_csi2_rx_subsyst_0_video_out_tuser;
  ...
  mipi_csi2_rx_axi_traffic_gen_1_0 axi_traffic_gen_1
       (.done(axi_traffic_gen_1_done),
        ...
        .status(axi_traffic_gen_1_status));
